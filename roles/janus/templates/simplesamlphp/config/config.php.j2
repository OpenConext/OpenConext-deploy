...
$config = array(
     ...
     */
    'baseurlpath' => '{{ janus_ssp_base_url_path }}',
    'certdir' => '{{ janus_ssp_cert_dir }}',
    'loggingdir' => '{{ openconext_logging_dir }}',
    'datadir' => '{{ janus_ssp_data_dir }}',
     ...
     */
    'debug' => {{ janus_ssp_debug }},

    'showerrors'            =>    {{ janus_ssp_showerrors }},
     ...
     */
    'auth.adminpassword'        => '{{ janus_ssp_auth_admin_password }}',
     ...
     */
    'secretsalt' => '{{ janus_ssp_secretsalt }}',
     ...
     */
    'technicalcontact_name'     => '{{ janus_ssp_technicalcontact_name }}',
    'technicalcontact_email'    => '{{ janus_ssp_technicalcontact_email }}',
    
    'managingcontact_name'     => '{{ janus_ssp_managingcontact_name }}',
    'managingcontact_email'    => '{{ janus_ssp_managingcontact_email }}',
     ...
     * 
     */
    'logging.level'         => {{ janus_ssp_logging_level }},
    'logging.handler'       => '{{ janus_ssp_logging_handler }}',
    ...
    'session.phpsession.savepath'    => '{{ janus_cache_path }}/janus/sessions',
    'session.phpsession.httponly'    => TRUE,

    /*
     * Option to override the default settings for the auth token cookie
     */
    'session.authtoken.cookiename' => '{{ janus_ssp_session_authtoken_cookiename }}',
    ...
    */
     ...
     */
    'store.type' => '{{ janus_ssp_store_type }}',
