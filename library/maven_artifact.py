...
# This module has been copied from ansible-modules-extra and can be removed as soon as downloading of
# the latest snapshot is included an ansible release (ansible 2.0.0.1 contains a maven_artifact module
# which does not download the latest snapshot version)
